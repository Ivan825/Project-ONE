...
\begin{abstract}
Many networks respond to measurements of their own state: markets to indices, organizations to metrics, platforms to trending signals. We present a controlled laboratory for this reflexive loop: an evolving population of agents forms an adaptive network whose macrostate is periodically compressed into a self-model and broadcast back --- accurately, systematically distorted, or as matched-bandwidth noise. Across 970 deterministic, seed-replayable runs with paired seeds and pre-registered outcomes we find that measurement without broadcast is causally inert; that a false self-model pulls the macrostate toward itself far more strongly than noise (Cliff's $\delta$ up to $0.85$); that the type of distortion sets the regime --- exploitative, mobilizing-but-self-defeating, or behaviorally inert; and that heritable attention to the broadcast is selected against in proportion to its unreliability: populations fed false self-models evolve to ignore their observer. Accurate feedback roughly doubles costly cooperation.
